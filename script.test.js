...
describe('README Fetch and Render', () => {
  ...
  it('should have OGP and Twitter meta tags in index.html', () => {
    ...
    expect(ogImageWidth.getAttribute('content')).toBe("960");
    expect(ogImageHeight).not.toBeNull();
    expect(ogImageHeight.getAttribute('content')).toBe("540");
    ...
    expect(twitterImage.getAttribute('content')).toBe("https://freddiefujiwara.com/ogp.png");
  });
});
